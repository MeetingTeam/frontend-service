...
const ChangePasswordPage=()=>{
          ...
          function handleOTPbutton(){
              ...
              CognitoService.forgotPassword(changePasswordDTO.email)
                .then(_=>alertSuccess("Send OTP code successfully"))
                .catch(err=>setError({
                    txtOTP: handleCognitoError(err)
                }));
          }
          ...
          function onSubmit(){
            if(validateChangePasswordDTO(changePasswordDTO)){
              CognitoService.confirmForgotPassword(changePasswordDTO.email, changePasswordDTO.OTPcode, changePasswordDTO.password)
                .then(_=>{
